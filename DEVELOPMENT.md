...
- [Node.js](https://nodejs.org/) (v22.x recommended — Next.js still runs under Node)
- [Bun](https://bun.sh/)
...
```bash
git clone https://github.com/lucaalberto-giorgi/portfolio.git luca-portfolio
cd luca-portfolio
```
...
If you're working on a different React project and want to reuse the custom components from this repository, visit [www.lucagiorgi.com/components](https://www.lucagiorgi.com/components) for installation instructions and component documentation.
