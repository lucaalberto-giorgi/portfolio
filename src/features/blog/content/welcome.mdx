---
title: Welcome to Luca Portfolio
description: Personal portfolio, component registry, and blog for Luca Alberto Giorgi.
...
Licensed under the [MIT license](https://github.com/lucaalberto-giorgi/portfolio/blob/main/LICENSE).

The source code is available on [GitHub](https://github.com/lucaalberto-giorgi/portfolio). You're free to use my code! Just make sure to remove all my personal information before publishing your website. It's awesome to see my code being useful to someone!
